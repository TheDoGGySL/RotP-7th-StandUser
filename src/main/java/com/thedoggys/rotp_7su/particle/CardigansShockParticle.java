package com.thedoggys.rotp_7su.particle;
...
public class CardigansShockParticle extends SpriteTexturedParticle {
    private final float yRot;
    private final float xRot;

    protected CardigansShockParticle(ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
    ...
    public static class Factory implements IParticleFactory<BasicParticleType> {
        ...
        public Particle createParticle(BasicParticleType type, ClientWorld world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            CardigansShockParticle particle = new CardigansShockParticle(world, x, y, z, xSpeed, ySpeed, zSpeed);
