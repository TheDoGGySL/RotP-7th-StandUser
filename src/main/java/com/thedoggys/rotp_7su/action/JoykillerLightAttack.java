...
public class JoykillerLightAttack extends StandEntityLightAttack {
    private final Supplier<StandEntityLightAttack> noAxeAttack;

    public JoykillerLightAttack(StandEntityLightAttack.Builder builder, Supplier<StandEntityLightAttack> noAxeAttack) {
