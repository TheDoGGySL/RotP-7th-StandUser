...
public class CardigansModel extends HumanoidStandModel<CardigansEntity> {
    ...
    protected void initActionPoses() { // TODO pickaxe throwing anim
        actionAnim.put(StandPose.RANGED_ATTACK, new PosedActionAnimation.Builder<CardigansEntity>()
    ...
    @Override
    public void prepareMobModel(CardigansEntity entity, float walkAnimPos, float walkAnimSpeed, float partialTick) {
    ...
    @Override
    protected IModelPose<CardigansEntity> initIdlePose2Loop() {
