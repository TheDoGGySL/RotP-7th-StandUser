...
public class BulletRenderer extends EntityRenderer<BulletEntity> {
    ...
    private static final ResourceLocation TRAIL_TEX = new ResourceLocation(AddonMain.MOD_ID, "textures/entity/projectiles/bullet_trace.png");
    @Override
    ...
    @Override
    public boolean shouldRender(BulletEntity entity, ClippingHelper pCamera, double pCamX, double pCamY, double pCamZ) {
    ...
    @Override
    public void render(BulletEntity entity, float yRotation, float partialTick, MatrixStack matrixStack, IRenderTypeBuffer buffer, int packedLight) {
    ...
    protected void trailSegment(Vector3d pos1, Vector3d pos2, float u0, float u1,
                                ...
                                BulletEntity entity, float yRotation, float partialTick, boolean first) {
        matrixStack.pushPose();
